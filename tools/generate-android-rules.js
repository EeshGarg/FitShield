 ...
 * engine/blocklist.js considers blockable (apex + alias domains of every
...
const engine = require("../engine/blocklist.js");
...
async function derive() {
  ...
  return {
    _generated: true,
    _doNotEdit:
      "GENERATED from canonical FitShield data (engine/blocklists/*.json) via the separated engine (engine/blocklist.js). " +
      "Run `npm run generate:android` to regenerate. Do NOT hand-edit — tools/android-audit.js fails the build on drift.",
    schema: 2,
    engine: "engine/blocklist.js",
    ...
    // engine/blocklist.js domainMatches): a query host is blocked when it equals an
...
// from engine/blocklist.js so the Android instrumentation test can assert the
...
async function deriveFixture() {
  ...
  return {
    ...
    engine: "engine/blocklist.js isBlockedHost",
